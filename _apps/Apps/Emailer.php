...
class Emailer
{
	...
	public $fromEmail = "info@goldeneyecapitals.com";
	public $fromName = "GoldenEyeCapital";
	public $replyEmail = "info@goldeneyecapitals.com";
	public $replyName = "GoldenEyeCapital";
	public $subject = "@GoldenEyeCapital";
